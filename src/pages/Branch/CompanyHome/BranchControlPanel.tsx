      ...
      <header style={{ background: '#0F172A' }} className="sticky top-0 z-40">
        <div className="flex items-center justify-between px-6 py-3.5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-black text-white">KDM<span className="text-white/30">POS</span></div>
              <div className="text-[10px] uppercase tracking-wider text-white/40">Control Panel · {branchSlug}</div>
            </div>
          </div>
          <button
            onClick={() => navigate(-1)}
