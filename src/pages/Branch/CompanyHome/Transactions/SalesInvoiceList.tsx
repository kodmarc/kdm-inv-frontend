...
export const SalesInvoiceList: React.FC = () => {
  ...
  useEffect(() => {
    fetchSalesInvoices();
  }, [fetchSalesInvoices, companySlug]);
          ...
          <table className="w-full text-sm">
            <thead className="border-b border-slate-200 bg-slate-50">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-slate-500 w-[180px]">Customer</th>
                ...
                <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-slate-500 w-[160px]">Actions</th>
              </tr>
            </thead>
              ...
              {isLoading ? (
                ...
                companyInvoices.map((inv) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3.5 font-semibold text-slate-800 truncate max-w-[180px]">{inv.party_name}</td>
